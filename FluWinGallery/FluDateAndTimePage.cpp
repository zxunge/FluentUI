...
FluDateAndTimePage::FluDateAndTimePage(QWidget* parent /*= nullptr*/) : FluATitlePage(parent)
{
    ...
    auto calendarDatePickerCard = new FluHCard(QPixmap("../res/ControlImages/CalendarDatePicker.png"), tr("CalendarDatePicker"), 
    ...
    auto calendarViewCard = new FluHCard(QPixmap("../res/ControlImages/CalendarView.png"), 
        tr("CalendarView"), tr("A control that presents aa calendar for a user to choose a date from."));
    ...
    auto datePickerCard = new FluHCard(QPixmap("../res/ControlImages/DatePicker.png"), 
        tr("DatePicker"), tr("A control that lets a user pick a date value."));
