...
FluScrollingPage::FluScrollingPage(QWidget* parent /*= nullptr*/) : FluATitlePage(parent)
{
    ...
    auto annotatedScrollBarCard = new FluHCard(QPixmap("../res/ControlImages/AnnotatedScrollBar.png"), tr("AnnotatedScrollBar"), 
    ...
    auto scrollViewCard = new FluHCard(QPixmap("../res/ControlImages/ScrollView.png"), tr("ScrollView"), 
