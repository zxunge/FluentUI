...
FluDialogsAndFlyoutsPage::FluDialogsAndFlyoutsPage(QWidget* parent /*= nullptr*/) : FluATitlePage(parent)
{
    ...
    auto contentDialogCard = new FluHCard(QPixmap("../res/ControlImages/ContentDialog.png"), tr("ContentDialog"), 
    ...
    auto TeachingTipCard = new FluHCard(QPixmap("../res/ControlImages/TeachingTip.png"), 
        tr("TeachingTip"), tr("A content-rich flyout for guiding users and enabling teaching moments."));
